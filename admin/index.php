        ...
        <div class="col-md-9 col-lg-9">
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            ...
            <table class="table table-responsive table-hover mt-3">
                  ...
                  <h3 class="mt-5">contacted customer</h3>
                  <table class="table table-responsive table-hover mt-3">
                      <thead class="thead-light">
                          <tr>
                              <th>id</th>
                        ...
                        <tbody>
                          <?php     
                            $query = "SELECT * FROM contact_us ORDER BY cont_id DESC LIMIT 5";
                            $run   = mysqli_query($con,$query);
                                        
                            if(mysqli_num_rows($run) > 0){
                              while($row = mysqli_fetch_array($run)){
                                $cust_id         = $row['cont_id'];
                                $cust_name       = $row['desi_id'];
                                $cust_email      = $row['cus_name'];    
                                $cust_city       = $row['cust_email'];
                                $cust_postalcode = $row['msg'];
                            ...
                            ?> 
                             <tr>
                              ...
                              echo "<tr><td colspan='12'><h2 class='text-center text-secondary'>No contacted Customer Yet</h2></td></tr>";
                            }
                    ?>
