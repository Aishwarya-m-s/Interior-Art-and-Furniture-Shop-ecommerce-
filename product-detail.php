...
//                     }
             ...
             <div class="form-group">
              ...
              <input type="number" name="qty" placeholder="Quantity" value="1" min="1" class="form-control w-25">
              </div>
      ...
      <section>
                           <?php
                     $p_query = "SELECT qty FROM furniture_product WHERE category LIKE '%$category%' order by title DESC LIMIT 4";
